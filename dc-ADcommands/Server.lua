    ...
    if string.starts(command, Config.Prefix) then
        ...
        elseif string.starts(command, Config.Prefix .. "heal") then
            ...
            if Config.ESX then
                ...
                local t = mysplit(command, " ")
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    TriggerClientEvent('esx_ambulancejob:heal', t[2])
                    
                    sendToDiscord("heal Succesfully",
                                  "Succesfuly heal " .. GetPlayerName(t[2]),
                                  16711680)
        ...
        elseif string.starts(command, Config.Prefix .. "getbank") then
            ...
            -- blackmoney
        elseif string.starts(command, Config.Prefix .. "getblackmoney") then
            ...
            if Config.ESX then
                ...
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    ...
                    if xPlayer then
                        ...
                        money = xPlayer.getAccount('black_money')
                        if money then
                            sendToDiscord("Discord Bot",
                                          "Target Currently Has : " ..
                                              money.money ..
        ...
        elseif string.starts(command, Config.Prefix .. "addaccountmoney") then
                ...
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    ...
                    if xPlayer then
                        ...
                        if t[3] ~= nil and t[4] ~= nil then
                            xPlayer.addAccountMoney( t[3] , tonumber(t[4]))
                            sendToDiscord("Discord BOT",
                                          "You Succesfuly added " .. t[3] .. ' to ' ..xPlayer.getName() .. ' amount ' .. t[4],
                                          16711680)
                        else
                            sendToDiscord("Discord BOT",
                                          "ID OR Money Input is invalid make sure you are writing like this: \n prefix + addaccountmoney + id + type + money",
                                          16711680)
                        end
        ...
        elseif string.starts(command, Config.Prefix .. "removeaccountmoney") then
            ...
            if Config.ESX then
                ...
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    ...
                    if xPlayer then
                        ...
                        if t[3] ~= nil and t[4] ~= nil then
                            xPlayer.removeAccountMoney( t[3] , tonumber(t[4]))
                            sendToDiscord("Discord BOT",
                                          "You Succesfuly remove " .. t[3] .. ' from ' ..xPlayer.getName() .. ' amount ' .. t[4],
                                          16711680)
                        else
                            sendToDiscord("Discord BOT",
                                          "ID OR Money Input is invalid make sure you are writing like this: \n prefix + removeaccountmoney + id + type + money",
                                          16711680)
                        end
                ...
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    ...
                    if xPlayer then
                        ...
                        if t[3] then
                            ...
                            sendToDiscord("Discord BOT", "You Succesfuly added ".. t[3] .. ' to ' ..xPlayer.getName() .. ' amount '.. t[4]  , 16711680)
                        else
                            sendToDiscord("Discord BOT",
                                          "ID OR Item Input is invalid make sure you are writing like this: \n prefix + giveitem + id + item + amount",
                                          16711680)
                        end
                ...
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    ...
                    if xPlayer then
                        ...
                        if t[3] then
                            ...
                            sendToDiscord("Discord BOT", "You Succesfuly remove ".. t[3] .. ' to ' ..xPlayer.getName() .. ' amount '.. t[4]  , 16711680)
                        else
                            sendToDiscord("Discord BOT",
                                          "ID OR Item Input is invalid make sure you are writing like this: \n prefix + removeitem + id + item + amount",
                                          16711680)
                        end
        ...
        elseif string.starts(command, Config.Prefix .. "skin") then
            if Config.ESX then
                local t = mysplit(command, " ")
                if t[2] ~= nil and GetPlayerName(t[2]) ~= nil then
                    TriggerClientEvent('esx_skin:openSaveableMenu', t[2])
                else
                    sendToDiscord("Could Not Find","Could Not Find An ID. Make Sure To Input Valid ID",16711680)
    ...
    local connect = {
        {
            ...
            ["title"] = "**" .. name .. "**",
            ["description"] = message,
            ["footer"] = {["text"] = "Developed By AloneDevShop"}
        }
    }
