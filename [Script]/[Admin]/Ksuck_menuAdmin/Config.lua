...
Config['ระบบการตั้งค่า'] = {
    KeyOpen = 'HOME',
    WeatherandBlackOut = false -- ระบบอากาศและปิดไฟของเมือง
}

Config['การตั้งค่าแสดงเฉพาะผู้ดูแลระบบ'] = {
    Distance = 20.0,
    DrawText = true,
    Scale = 1.0,
    Health = true
}
Config['สภาพอากาศแบบไดนามิก'] = false -- Set this to false if you don't want the weather to change automatically every 10 minutes.
Config['ไฟดับ'] = false --ไฟในเมืองดับตลอด
Config['สภาพอากาศเริ่มต้น'] = 'CLEAR' -- Default weather
Config['BaseTime'] = 8 
Config['ใหม่ WeatherTimer'] = 15 -- เวลา (เป็นนาที) ระหว่างการเปลี่ยนแปลงของสภาพอากาศแต่ละครั้ง
Config['อัพเดทเวลา'] = 7 --Delay Update Time ปรับเวลาให้เหมือนกันทั้งเซิฟ
...
Config.Noclip = {
    ...
    { text = 'fast' , speed = 3},
    { text = 'super fast' , speed = 5},
    { text = 'super very fast' , speed = 10},
}
...
Config.PedModel = {
    ...
    {model = 'a_c_shepherd',label = "shepherd"},
    {model = 'a_c_rottweiler',label = "bulldog"},
    {model = 'a_c_poodle',label = "poodle"},
    {model = 'a_c_coyote',label = "coyote"},
    {model = 'a_c_chop',label = "chop"},
    {model = 'a_c_husky',label = "husky"},
    {model = 'a_c_retriever',label = "husky"},
    {model = 'a_c_pug',label = "pug"},
    --แมว
    {model = 'a_c_cat_01',label = "cat"},
    --นก
    {model = 'a_c_crow',label = "crow"},
    --คน
    {model = 'cs_bradcadaver',label = "bradcadaver"},
    {model = 'cs_orleans',label = "orleans"},
    {model = 's_m_m_movalien_01',label = "movalien"},
    {model = 's_m_m_movspace_0',label = "buzz lightyear"},
    {model = 'u_m_y_rsranger_01',label = "buzz ly2"},
    {model = 'u_m_m_jesus_01',label = "jesus"},
    {model = 'u_m_y_imporage',label = "super hero"},
    {model = 'u_m_y_juggernaut_01',label = "tank"},
    {model = 'u_m_y_pogo_01',label = "pogo"},
    {model = 'u_m_y_zombie_01',label = "zombie"},
    {model = 'u_m_y_staggrm_01',label = "gay"},
}
