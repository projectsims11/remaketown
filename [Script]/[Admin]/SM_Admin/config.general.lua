...
Config["Options"] = {
    ["TimeOptions"] = {
        BaseTime = 8,  -- เวลาเริ่มต้นเมื่อเปิดเซิฟ
        updateTime = 15 * 1000,  -- เวลาที่จะอัพเดท เวลาในเมือง
    },
    ["WeatherOptions"] = {
        Blackout = false,  -- ตั้งค่าเริ่มต้น เปิด/ปิด ไฟในเมือง ถ้า useReplightScript true ตัวนี้จะไม่มีผล
        StartWeather = "EXTRASUNNY",  -- สภาพเริ่มต้นเมื่อเปิดเซิฟ
        updateWeather = 30 * 1000,  -- เวลาที่จะอัพเดท สภาพอากาศ
        DynamicWeather = false,  -- เปลี่ยนสภาพอากาศอัตโนมัติ
        NewWeatherTimer = 30,  -- ระยะเวลาในการเปลี่ยนสภาพอากาศ
