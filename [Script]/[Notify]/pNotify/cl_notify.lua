...
RegisterCommand("notify1", function(source, args, rawCommand)
    testnotify1()
end)
...
function testnotify1()
    exports.pNotify:SendNotification({ text="กำลังทดสอบ test 123",type="success"})
end
function testnotify2()
    exports.pNotify:SendNotification({ text="กำลังทดสอบ test 123",type="error"})
end
function testnotify3()
    exports.pNotify:SendNotification({ text="กำลังทดสอบ test 123",type="warning"})
end
function testnotify4()
    exports.pNotify:SendNotification({ text="กำลังทดสอบ test 123",type="info"})
end
function testnotify5()
    exports.pNotify:SendNotification({ text="กำลังทดสอบ test 123",type="alert"})
end
