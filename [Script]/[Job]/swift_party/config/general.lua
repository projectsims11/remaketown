...
config.party = {
    timerSettings = {
        ...
        [2] = 250, -- หากจำนวนคนในปาร์ตี้เท่ากับ 2 คน จะลบเวลาฟาร์มเดิมเท่าไหร่ (ตัวอย่าง 6000 - 250 = 5750)
        [3] = 500, -- หากจำนวนคนในปาร์ตี้เท่ากับ 3 คน จะลบเวลาฟาร์มเดิมเท่าไหร่ (ตัวอย่าง 6000 - 500 = 5500)
        [4] = 750,
        [5] = 1000,
        [6] = 1500
