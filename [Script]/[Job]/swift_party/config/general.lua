...
config.party = {
    timerSettings = {
        ...
        [2] = 5000, -- หากจำนวนคนในปาร์ตี้เท่ากับ 2 คน จะลบเวลาฟาร์มเดิมเท่าไหร่ (ตัวอย่าง 6000 - 250 = 5750)
        [3] = 5000, -- หากจำนวนคนในปาร์ตี้เท่ากับ 3 คน จะลบเวลาฟาร์มเดิมเท่าไหร่ (ตัวอย่าง 6000 - 500 = 5500)
        [4] = 750,
        [5] = 1000,
        [6] = 1500
    }, -- จะเพิ่มกี่คนก็ได้ ไม่จำกัด

    minimumTimer = 4000, -- สามารถลดเวลาได้ต่ำสุดเท่าไหร่ (ตัวอย่าง 6000 - 3000 = 3000 ระบบจะเซ็ตให้เป็น 4000 แทน)
    maxPlayers = 6, -- จำกัดจำนวนคนในปาร์ตี้
...
config.matchMaking = {
    ...
    minPlayers = 6, -- ต้องการผู้เล่นกี่คนถึงจะสร้างปาร์ตี้
