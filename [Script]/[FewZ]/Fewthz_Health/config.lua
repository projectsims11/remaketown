...
cfg = {
	...
	damageFactorPetrolTank = 64.0,				-- ค่าที่เป็นกลางคือ 1 ถึง 200 ค่าที่สูงขึ้นหมายถึงความเสียหายมากขึ้นกับยานพาหนะ จุดเริ่มต้นที่ดีคือ 64
	...
	degradingFailureThreshold = 500.0,			-- ด้านล่างค่านี้การย่อยสลายทางสุขภาพที่ช้าจะเกิดขึ้น
