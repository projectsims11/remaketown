...
RegisterNetEvent("Fewthz_inventory:openHouseInventory")
AddEventHandler("Fewthz_inventory:openHouseInventory",function(id, cash, blackMoney, inventory, weapons)
    setHouseInventoryData(id, cash, blackMoney, inventory, weapons)
    openHouseInventory()
end)

RegisterNetEvent("Fewthz_inventory:refreshHouseInventory")
AddEventHandler("Fewthz_inventory:refreshHouseInventory", function(id, cash, blackMoney, inventory, weapons)
    setHouseInventoryData(id, cash, blackMoney, inventory, weapons)
    Wait(150)
    openHouseInventory()
end)
