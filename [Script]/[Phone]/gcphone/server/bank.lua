...
AddEventHandler("gcPhone:transfer", function(a, b)
    ...
    if e ~= nil then
        ...
        if tonumber(c) == tonumber(a) then
            --exports['mythic_notify']:SendAlert('success', c, _U('send_yourself'), 3*1000)
            ...
            if f <= 0 or f < tonumber(b) or tonumber(b) <= 0 then
                ...
                --exports['mythic_notify']:SendAlert('success', c, "$" .. b ..  _U('bank_sending'), 3*1000)
                --exports['mythic_notify']:SendAlert('success', a, "$" .. b ..  _U('bank_incoming'), 3*1000)
        ...
        --exports['mythic_notify']:SendAlert('error', c, _U('no_player_id'), 3*1000)
