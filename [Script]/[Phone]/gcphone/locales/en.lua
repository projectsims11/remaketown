Locales['en'] = {
    ['no_item']                 = "คุณไม่มีมือถือในกระเป๋า",
    ['send_yourself']			= '<font face="sarabun">ไม่สามารถโอนเงินให้ตัวเองได้</font>',
    ['not_enough_money']		= "เงินในบัญชีของคุณไม่พอ",
    ['bank_sending']			= '<font face="sarabun">คุณได้โอนเงินเรียบร้อยแล้ว</font>',
    ['bank_incoming']			= '<font face="sarabun">คุณได้รับเงินจากการโอน</font>',
    ['no_player_id']			= '<font face="sarabun">ไม่พบไอดีนี้</font>',
	...
	['not_enough_money']		= "You not have money",
