...
Config.Distance           = 100.00 -- ผู้เล่นต้องอยู่ในระยะเท่าไหร่ถึงจะแสดง
Config.Time_Show          = 1500   -- เวลาที่แสดง 1000 = 1วินาที
...
-- ข้อความชื่อไอเทม
Config.Text_Show          = true      -- true = แสดงข้อคาวามชื่อไอเทม
Config.Text_Count_Show    = false      -- true = แสดงข้อคาวามจำนวนไอเทม
Config.Text_Size          = 0.5      -- ขนาดข้อความ
Config.Text_Font          = 'sarabun' -- Font
