...
Config.Hold_Action = {
	...
	['carry4'] = {
		...
		["target"] = {
			TaskAnim = {
				animDictionary = "penguin@custom@v1",
				animationName = "penguin_carry_f",
				blendInSpeed = 8.0,
				blendOutSpeed = -8.0,
				duration = -1,
				flag = 33,
	...
	['carry6'] = {
		["source"] = {
			TaskAnim = {
				animDictionary = "penguin@custom@v2",
				animationName = "penguin_duo1_m",
				blendInSpeed = 8.0,
				blendOutSpeed = 8.0,
				duration = -1,
				flag = 1,
