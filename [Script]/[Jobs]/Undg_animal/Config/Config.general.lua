...
Config.Default = {
    ...
    Manage = {
        ...
        Vip = { -- ถ้าอยากให้คนทั่วไปใช้ Auto ได้ ปรับแบบนี้ Vip = nil,
            ...
            [2] = {
                Item = 'stone', -- ชื่อไอเทม Vip
                Spawn = 15,     -- สามารถเลี้ยงสัตว์ได้กี่ตัว
                Auto = true,    -- สามารถเลี้ยง Auto ได้ไหม
            },
        },
    },
    ...
    Animals = {
        [1] = {
            ...
            Growth = 100,                 -- เป็นค่าหลอดการเติบโตหากปรับเป็น 100 แล้ว Growspeed = 1 Loop จะเพิ่มทีละ 1 จนครบ 100 ถึงจะเก็บได้
            Growspeed = 1,                -- เติบโตทีละกี่เปอร์เซ็นต์ แนะนำเป็น 1 ไม่งั้นเวลาจะไม่ตรง
            Feed = {20, 40, 60, 80, 95},  -- หากสัตว์เลี้ยงโตถึง 5 หรือ 20 จะต้องให้อาหาร
