...
function pay(source, accessory)
	...
	local sendToDiscord = '' .. xPlayer.name .. ' ซื้อ ' .. accessory .. ' เสียค่าใช้จ่าย $' .. ESX.Math.GroupDigits(Config.Price) .. ' ให้ ร้านเครื่องประดับ'
	TriggerEvent('azael_dc-serverlogs:sendToDiscord', 'AccessoriesShop', sendToDiscord, xPlayer.source, '^3')
end
