...
RegisterNetEvent("FewthzNotify:SendNotification")
AddEventHandler("FewthzNotify:SendNotification", function(options)
    SendNotification(options)
end)

RegisterNetEvent("FewthzNotify:SetQueueMax")
AddEventHandler("FewthzNotify:SetQueueMax", function(queue, max)
