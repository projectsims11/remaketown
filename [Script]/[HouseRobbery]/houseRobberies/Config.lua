...
Config.Item = { 
    Item = 'lockpick', -- [ ไอเทมที่กดใช้ปล้นบ้าน ]
    Remove = 1, -- [ ลบกี่จำนวน ]
}

Config.GiveMoney = {  -- เงินที่จะได้จากการปล้น Safe
    Min = 500, -- [ เงินน้อยสุด ]
    Max = 3000, -- [ เงินมากสุด ]
}
...
Config.DropsWeaponsWhenDead = false -- [ เมื่อ NPC ตายให้ดรอปปืนที่ถือ true ดรอป - false ไม่ดรอป ]

Config.WeaponNPC = 'WEAPON_PISTOL' -- [ อาวุธที่ NPC ถือ ]

Config.ItemDrop = {
    [1] = {Percent = 50.0, id = 0, name = 'money', quantity = 10, 3000}, 
    [2] = {Percent = 50.0, id = 'Aed', name = 'Aed', quantity = 1, 2},
    [3] = {Percent = 50.0, id = 'clip', name = 'กระสุน', quantity = 1, 5},
    [4] = {Percent = 50.0, id = 'gold', name = 'แท่งทอง', quantity = 2, },
    [5] = {Percent = 50.0, id = 'coke_pooch', name = 'โคเคนแพ็ค', quantity = 2, 4},
    [6] = {Percent = 50.0, id = 'weed_pooch', name = 'กัญชาแพ็ค', quantity = 2, 4}, 
}

Config.robbableItems = { -- [ ตำแหน่งค้นหาในบ้าน ] ** ห้ามแก้
